...
EOD;
	...
	public static function renderAttributes($htmlOptions)
	{
        ...
        {
          $combo = CatalogTree::model()->allCombo();  ?>             
            <div class="col-lg-3 col-sm-4 col-md-4 left_men">                
              <ul id="menuu" class="list-group drop_vert_men">
                  <?php 
                  foreach ($combo as $key){
                  ?>                                    
                  <li class="list-group-item secondmenu dropdown-submenu" style="height:70px;padding: 6px 0 0px 5px;">                
                    <!--<a href="/catalog/avto/<?php echo $key['chpu'] ; ?>">-->
                    <a>
                        <img src="/data/catalog/features/<?php echo $key['chpu'].'/'. $key['image'] ; ?>" width="85" >
                        <span class="right_text"> <?php echo $key['title'] ; ?></span>
                    </a>                    
                       <ul class="dropdown-menu">
                           <?php     
                           foreach ($key['children'] as  $children) { ?>
                           <li class="menu_a" style="height: 33px;"><a tabindex="-1" href="/catalog/avto/<?php echo $key['chpu'] ; ?>/<?php echo $children['chpu'] ; ?>"> <?php echo $children['title'] ; ?></a></li>                                                                                                        
                           <?php   } ?>
                    </ul>
                </li>                
                <?php  } ?>                
...
border-radius: 0px;
   ...
   .drop_vert_men ul li:hover{
    ...
    .drop_vert_men ul li a{
   
   } 
   .drop_vert_men ul li a:hover{
...
var url = window.location;                    
  ...
  <?php    
        ...
        public static function leftMenusingle()
        {
          $combo = CatalogTree::model()->oneCombo();  ?>             
            <div class="col-lg-3 col-md-4 col-sm-3 left_men">                
              <ul id="menuu" class="list-group drop_vert_men">
                  <?php 
                  foreach ($combo as $key){
                  ?>                                    
                  <li class="list-group-item secondmenu dropdown-submenu" style="  height: 70px;
  padding: 1px 0 0 2px;">                
                    <a >
                        <img src="/data/catalog/features/<?php echo $key['chpu'].'/'. $key['image'] ; ?>" width="85" >
                        <span class="right_text"> <?php echo $key['title'] ; ?></span>
